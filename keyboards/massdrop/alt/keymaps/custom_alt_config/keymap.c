...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_HOME, \
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    MD_BOOT,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN, \
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    /*
    [X] = LAYOUT(
...
#define LAYER0_COLOR 0x8050A0  // dim medium purple (R=0x80, G=0x50, B=0xA0)
#define LAYER1_COLOR 0x50A050  // dim medium green  (R=0x50, G=0xA0, B=0x50)

led_instruction_t led_instructions[] = {
    { .flags = LED_FLAG_USE_ROTATE_PATTERN },

    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB,
      .id0 = 0xFFFFFFFF, .id1 = 0xFFFFFFFF, .id2 = 0xFFFFFFFF, .id3 = 0x000001FF,
      .r = (LAYER0_COLOR >> 16) & 0xFF,
      .g = (LAYER0_COLOR >>  8) & 0xFF,
      .b = (LAYER0_COLOR >>  0) & 0xFF,
      .layer = 0 },

    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB,
      .id0 = 0xFFFFFFFF, .id1 = 0xFFFFFFFF, .id2 = 0xFFFFFFFF, .id3 = 0x000001FF,
      .r = (LAYER1_COLOR >> 16) & 0xFF,
      .g = (LAYER1_COLOR >>  8) & 0xFF,
      .b = (LAYER1_COLOR >>  0) & 0xFF,
      .layer = 1 },
